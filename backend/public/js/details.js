...
function getBuddy(id){
	$.getJSON(`buddy/${id}`, function (profile) {
        ...
        var formContent = '<div class="mdl-cell">';
        ...
        header.forEach(function(key, index){
            ...
            else if(key === "categories") formContent += `${key.toUpperCase()}: ${JSON.stringify(profile[key])} <br/>`;
        ...
        formContent += `<a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="/detail.html?id=${profile["moodle_id"]}">Termin ausmachen</a>`;
